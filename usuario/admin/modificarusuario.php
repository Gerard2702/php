...
<center><h6>PC-Locker<br><strong>Modificar Empresa</strong></h6></center>
	<form method="post" action="../../usuario/admin/save2.php" id="formmodifempresa">
	...
	<div class="input-field">
		<i class="material-icons prefix">subject</i>
        <input placeholder="Apellido" name="apellido" value="'.$datos['apellido'].'" type="text" class="validate" required>
    </div>
	<div class="input-field">
		<i class="material-icons prefix">subject</i>
